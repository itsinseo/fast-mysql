package com.example.fastmysql.domain.post.repository;
...
public class TimelineRepository {
    ...
    public List<Timeline> findLessThanIdAndByMemberIdAndOrderByIdDesc(Long id, Long memberId, int size) {
        var sql = String.format("""
                SELECT *
                FROM %s
